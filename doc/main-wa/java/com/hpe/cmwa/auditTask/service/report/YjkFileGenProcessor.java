 ...
 */
@Service
public class YjkFileGenProcessor extends CommonSubjectFileGenProcessor {
	// 当前专题生成汇总审计报告所需要"跑完模型的关注点数量"
	@Autowired
	YjkGenService yjkGenService;
	...
	public File genProvDocFile(String audTrm, String subjectId,  int prvdId, Map<String, Object> configInfo,	Map<String, Object> request,Boolean useChineseName) {
		...
		Map<String, List<Object>> dataMap = yjkGenService.selectPageData(params);
