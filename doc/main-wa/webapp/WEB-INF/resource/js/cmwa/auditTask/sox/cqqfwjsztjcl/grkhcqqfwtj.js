...
function initEvent(){
	...
	$("#exportCqqfwtjzhs_sf_Table").click(function() {
        ...
        window.location.href = $.fn.cmwaurl() + "/grkhcqqfwtj/exportCqqfwtjzhs_sf_Detail?" + $.param(getHZ_QueryParam());
	...
	$("#exportCqqfwtjzhs_zh_Table").click(function() {
        ...
        window.location.href = $.fn.cmwaurl() + "/grkhcqqfwtj/exportCqqfwtjzhs_zh_Detail?" + $.param(postData);
    });
    ...
    $("#exportMxDetailList").click(function() {
        ...
        window.location.href = $.fn.cmwaurl() + "/grkhcqqfwtj/exportMxDetailList?" + $.param(getDetailQueryParam());
    });
...
function initDefaultParams(){
    ...
    $.ajax({
        url : $.fn.cmwaurl() + "/grkhcqqfwtj/initDefaultParams",
        async : false,
        dataType : 'json',
        data : postData,    
...
function reLoadCityDetailGridData() {
    ...
    var url1 = $.fn.cmwaurl() + "/grkhcqqfwtj/getCityDetailPagerList";
...
function loadMxCityList() {
    var postData = getDetailQueryParam();
    $.ajax({
        url : $.fn.cmwaurl() + "/grkhcqqfwtj/getCityList",
        dataType : 'json',
        data : postData,    
        success : function(data) {
        	var li = "";
...
function reloadCqqfwtjzhs_sf_DetailTable() {
	var postData = getHZ_QueryParam(); 
    var url = $.fn.cmwaurl() + "/grkhcqqfwtj/loadCqqfwtjzhs_sf_TabDetailTable";
...
function reloadCqqfwtjzhs_zh_DetailTable() {
	var postData = getHZ_QueryParam(); 
    var url = $.fn.cmwaurl() + "/grkhcqqfwtj/loadCqqfwtjzhs_zh_TabDetailTable";
...
function loadCqqfwtjzhsChart(){
    ...
    $.ajax({
        url : $.fn.cmwaurl() + "/grkhcqqfwtj/getGrkhcqqfwtjChart",
        dataType : 'json',
        async : false,
        data : postData,    
        success : function(data) {
...
function loadCqqfwtjzhs_sf_TabDetailTable(tableId,pagerId){
    ...
    jQuery("#"+tableId).jqGrid({
    	url : $.fn.cmwaurl() + "/grkhcqqfwtj/loadCqqfwtjzhs_sf_TabDetailTable",
        datatype: "json",
        postData: postData,
...
function loadCqqfwtjzhs_zh_TabDetailTable(tableId,pagerId){
	...
	var tableColNames = [ '审计月','省名称','地市名称','帐户标识','用户标识','客户标识','欠费账期','欠费金额(元)'];
    var tableColModel = [];
    ...
    jQuery("#"+tableId).jqGrid({
    	url : $.fn.cmwaurl() + "/grkhcqqfwtj/loadCqqfwtjzhs_zh_TabDetailTable",
        datatype: "json",
        postData: postData,
        colNames: tableColNames,
        colModel: tableColModel,
...
function loadMxCityDetailGridData(){
	var postData = getDetailQueryParam();
	   var url= "/grkhcqqfwtj/getCityDetailPagerList";
	   var tableColNames = [ '审计月','省名称','地市名称','帐户标识','用户标识','客户标识','欠费科目','欠费账期','欠费金额(元)'];
	   var tableColModel = [
