...
function loadQdhyPrvd(){
	...
	$.ajax({
		url : $.fn.cmwaurl() + "/hyzdbthgx/1701/getQdhyPrvd",
		dataType : 'json',
		data : postData,
		success : function(data) {
...
function loadOnlineMon(){
	var postData = getSumQueryParam();
	$.ajax({
		url : $.fn.cmwaurl() + "/hyzdbthgx/1701/getOnlineMon",
		dataType : 'json',
		data : postData,
		success : function(data) {
...
function loadOnlineMonTalbe(tableId,data){
	...
	if(sum != 0){
		...
		htmlstr =htmlstr+ "<tr>" +
			"<td>7-12月</td>" +
			"<td>"+formatCurrency(mon6,false)+"</td>" +
		...
		"<th>"+formatCurrency(sum,false)+"</th>" +
				"<th>"+sum/sum*100+"%</th>" +
				"</tr>";
	}else{
		htmlstr = htmlstr+"<tr>" +
...
function loadSumOfferTable(tableId,pagerId) {
    ...
    jQuery("#"+tableId).jqGrid({
    	url : $.fn.cmwaurl() + "/hyzdbthgx/1701/getSumOffer",
        datatype: "json",
        postData: postData,
...
function loadDetailTable(tableId,pagerId){
    ...
    jQuery("#"+tableId).jqGrid({
    	url : $.fn.cmwaurl() + "/hyzdbthgx/1701/getDetailListPager",
        datatype: "json",
        postData: postData,
        colNames: tableColNames,
        colModel: tableColModel,
...
function reLoadCityDetailGridData(tableId) {
    var postData = getDetailQueryParam();
    var url = $.fn.cmwaurl() + "/hyzdbthgx/1701/getDetailListPager";
...
function exportTab(functionName){
	...
	var url = $.fn.cmwaurl() + "/hyzdbthgx/1701/" +functionName+
