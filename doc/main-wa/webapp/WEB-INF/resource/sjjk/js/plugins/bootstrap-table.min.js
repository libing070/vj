...
! function(a) {
    ...
    var b = null,
        ...
        l = function(a, b, c) { var d = a; if ("string" != typeof b) return c ? j(a[b]) : a[b]; var e = b.split("."); for (var f in e) e.hasOwnProperty(f) && (d = d && d[e[f]]); return c ? j(d) : d },
    ...
    o.DEFAULTS = {
        ...
        g || i.append('<tr class="no-records-found">' + c('<td colspan="%s">%s</td>', this.$header.find("th").length, this.options.formatNoMatches()) + "</tr>"), this.$body.html(i), b || this.scrollTo(0), this.$body.find("> tr[data-home] > td").off("click dblclick").on("click dblclick", function(b) {
            var f = a(this),
                g = f.parent(),
        ...
        }), this.$body.find("> tr[data-home] > td > .detail-icon").off("click").on("click", function() {
            var b = a(this),
                e = b.parent().parent(),
                g = e.data("index"),
                i = f[g];
        ...
        this.$header_ = this.$header.clone(!0, !0), this.$selectAll_ = this.$header_.find('[name="btSelectAll"]'), this.$tableHeader.css({ "margin-right": "" }).find("table").css("width", this.$el.outerWidth()).html("").attr("class", this.$el.attr("class")).append(this.$header_), f = a(".focus-temp:visible:eq(0)"), f.length > 0 && (f.focus(), this.$header.find(".focus-temp").removeClass("focus-temp")), this.$header.find("th[data-field]").each(function() { h.$header_.find(c('th[data-field="%s"]', a(this).data("field"))).data(a(this).data()) });
        ...
        var d = this.$selectItem.filter(c('[data-home="%s"]', b)).prop("checked", a);
        ...
        if (d.hasOwnProperty("field") && d.hasOwnProperty("values")) {
            ...
            a.each(this.options.data, function(g, h) {
                ...
                if (-1 !== a.inArray(h[d.field], d.values)) {
                    var i = e.$selectItem.filter(":enabled").filter(c('[data-home="%s"]', g)).prop("checked", b);
        ...
        var d = this.$body.find(c('> tr[data-home="%s"]', b));
        ...
        if (b) {
            var d = this.$body.find(c('> tr[data-home="%s"]', 0)),
                e = this,
                f = null,
                g = !1,
                h = -1;
