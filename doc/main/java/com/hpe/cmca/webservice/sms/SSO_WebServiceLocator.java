...
public class SSO_WebServiceLocator extends org.apache.axis.client.Service implements com.hpe.cmca.webservice.sms.SSO_WebService {
    ...
    public com.hpe.cmca.webservice.sms.SSO_WebServiceSoap_PortType getSSO_WebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.hpe.cmca.webservice.sms.SSO_WebServiceSoap_PortType getSSO_WebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hpe.cmca.webservice.sms.SSO_WebServiceSoap_BindingStub _stub = new com.hpe.cmca.webservice.sms.SSO_WebServiceSoap_BindingStub(portAddress, this);
    ...
    public com.hpe.cmca.webservice.sms.SSO_WebServiceSoap_PortType getSSO_WebServiceSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public com.hpe.cmca.webservice.sms.SSO_WebServiceSoap_PortType getSSO_WebServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hpe.cmca.webservice.sms.SSO_WebServiceSoap12Stub _stub = new com.hpe.cmca.webservice.sms.SSO_WebServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hpe.cmca.webservice.sms.SSO_WebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hpe.cmca.webservice.sms.SSO_WebServiceSoap_BindingStub _stub = new com.hpe.cmca.webservice.sms.SSO_WebServiceSoap_BindingStub(new java.net.URL(SSO_WebServiceSoap_address), this);
                _stub.setPortName(getSSO_WebServiceSoapWSDDServiceName());
                return _stub;
            }
            if (com.hpe.cmca.webservice.sms.SSO_WebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hpe.cmca.webservice.sms.SSO_WebServiceSoap12Stub _stub = new com.hpe.cmca.webservice.sms.SSO_WebServiceSoap12Stub(new java.net.URL(SSO_WebServiceSoap12_address), this);
                _stub.setPortName(getSSO_WebServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
