/**
 * com.hp.cmcc.job.service.NotiFileDzq6000PrvdOfferProcessor.java
 ...
 * </pre>
 */
@Service("NotiFileDzq6000PrvdOfferProcessor")
public class NotiFileDzq6000PrvdOfferProcessor extends AbstractNotiFileProcessor {
	...
	this.setFileName("电子券管理违规营销案清单_"+prvdName+"_" + month);
	// 获取新文件名
