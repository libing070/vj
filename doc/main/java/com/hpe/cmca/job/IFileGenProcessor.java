...
public interface IFileGenProcessor {
	 ...
	 * </pre>
	 */
	public void genFile(String audTrm, String subjectId, String totalFocusCds, String focusCd, int prvdId, Map<String, Object> request, int modelNotifyId, Map<String, Object> configInfo, Boolean useChineseName, Boolean flag);
