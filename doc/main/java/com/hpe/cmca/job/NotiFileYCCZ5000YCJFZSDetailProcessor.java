/**
 * com.hp.cmcc.job.service.NotiFileYCCZ5000YCJFZSDetailProcessor.java
 ...
 * @author   hufei
 * @refactor hufei
 * @date     2018-1-26 上午10:22:44
 * @version  1.0
 *  
 * REVISIONS: 
 * Version 	   Date 		    Author 			  Description
 * ------------------------------------------------------------------- 
 * 1.0 		  2018-1-26 	   hufei 	         1. Created this class. 
 * </pre>  
 */
@Service("NotiFileYCCZ5000YCJFZSDetailProcessor")
public class NotiFileYCCZ5000YCJFZSDetailProcessor extends AbstractNotiFileProcessor {
    @Autowired
	...
	this.setFileName("异常积分赠送积分值排名前50用户明细_全国_" + month);
	Map<String,Object> paramMap=new HashMap<String,Object>();
	paramMap.put("focusCd", "5001");
