/**
 * com.hp.cmcc.job.service.NotiFileLlzs8000PrvdChnl.java
 ...
 * </pre>  
 */
@Service("NotiFileLlzs8000PrvdChnlProcess")
public class NotiFileLlzs8000PrvdChnlProcess extends AbstractNotiFileProcessor {
	...
	this.setFileName("异常赠送渠道清单_"+prvdName+"_" + month);
	// 获取新文件名
