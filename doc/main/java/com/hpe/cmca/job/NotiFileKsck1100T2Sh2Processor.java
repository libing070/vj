 ...
 * </pre>
 */
@Service("NotiFileKsck1100T2Sh2Processor")
public class NotiFileKsck1100T2Sh2Processor extends AbstractNotiFileProcessor {
	...
	this.setFileName("跨省窜卡入网渠道排名_全国表2_"+ month);//
	// 获取新文件名
	Map<String,Object> paramMap=new HashMap<String,Object>();
	paramMap.put("focusCd", "t2sh2");
