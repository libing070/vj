/**
 * com.hp.cmcc.job.service.NotiFileYCCZ5000YCTFDetailProcessor.java
 ...
 * </pre>  
 */
@Service("NotiFileYCCZ5000YCTFDetailProcessor")
public class NotiFileYCCZ5000YCTFDetailProcessor extends AbstractNotiFileProcessor {
	...
	this.setFileName("异常退费金额排名前100账户明细_全国_" + month);
	// 获取新文件名
	Map<String,Object> paramMap=new HashMap<String,Object>();
	paramMap.put("focusCd", "5004");
