/**
 * com.hp.cmcc.job.service.NotiFileYCCZ5000YCJFZYDetailProcessor.java
 ...
 * </pre>  
 */
@Service("NotiFileYCCZ5000YCJFZYDetailProcessor")
public class NotiFileYCCZ5000YCJFZYDetailProcessor extends AbstractNotiFileProcessor {
	...
	this.setFileName("异常转移积分值排名前50用户明细_全国_" + month);
	// 获取新文件名
	Map<String,Object> paramMap=new HashMap<String,Object>();
	paramMap.put("focusCd", "5002");
