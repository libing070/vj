/**
 * com.hp.cmcc.job.service.v2.Llzs8000FileGenProcessor.java
 ...
 * @author   hufei
 * @refactor hufei
 * @date     2017-8-14 上午11:16:18
 * @version  1.0
 *  
 * REVISIONS: 
 * Version 	   Date 		    Author 			  Description
 * ------------------------------------------------------------------- 
 * 1.0 		  2017-8-14 	   hufei 	         1. Created this class. 
 * </pre>  
 */
public class Llzs8000FileGenProcessor  extends CommonSubjectFileGenProcessor {
	...
	if (prvdId != Constants.ChinaCode) {
	    ...
	    if (concernList.size() < focusCdsCount) {// 代表该省的1个员工异常操作关注点并未都执行完毕，所以不需要生成审计报告
		return false;
	    }
	}
	return true;
