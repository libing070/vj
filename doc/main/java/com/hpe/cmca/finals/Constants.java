...
import com.hpe.cmca.util.HelperString;
import com.hpe.cmca.util.Key_Value;
...
public final class Constants {
	...
	// 省公司ID和名称映射  20161019 add By GuoXY for 审计报告生成job
	    ...
	    static {
            ...
            MAP_PROVD_NAME.put(13200,"广州支撑中心");
            MAP_PROVD_NAME.put(13300,"深圳支撑中心");
            MAP_PROVD_NAME.put(13400,"北京支撑中心");
...
//	    	MAP_SUBJECT_NAME.put("8","流量异常赠送");
	    ...
	    static {
			...
			MAP_FOCUSCD_NAME.put("4000","客户欠费");//用于清单名称
			MAP_FOCUSCD_NAME.put("4001","客户欠费");//用于清单名称
			MAP_FOCUSCD_NAME.put("4003","上期长期高额欠费客户本期回收");//用于清单名称
			...
			MAP_FOCUSCD_NAME.put("5005","公免及测试号积分兑换");
	    	...
	    	MAP_FOCUSCD_NAME.put("7003","流量异常赠送");
	...
	public static final Map<String,String> ZDTLNameMap = new HashMap<String, String>();

	public static final Map<String,String> ZDTLAttrNameMap = new HashMap<String, String>();
	public static final Map<String,String> QDYKAttrNameMap = new HashMap<String, String>();

	static {
		ZDTLNameMap.put("3001", "沉默串码");
		ZDTLNameMap.put("3002", "养机");
		ZDTLNameMap.put("3004", "拆包");
		ZDTLNameMap.put("3005", "跨省窜货");

		ZDTLAttrNameMap.put("ycxssl", "异常销售数量");
		ZDTLAttrNameMap.put("ycxszb", "异常销售占比");
		ZDTLAttrNameMap.put("tlzdsl", "套利终端数量");
		ZDTLAttrNameMap.put("tlzdzb", "套利终端占比");

		QDYKAttrNameMap.put("ykhmsl", "疑似养卡号码数量");
		QDYKAttrNameMap.put("ykhmzb", "疑似养卡号码占比");
		QDYKAttrNameMap.put("sjqdsl", "涉及渠道数量");
		QDYKAttrNameMap.put("sjqdzb", "涉及渠道占比");
	}
